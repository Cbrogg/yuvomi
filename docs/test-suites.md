...
npm run test:outlook-calendar   # Outlook-Push (Graph): RRULE→pattern/range-Mapping, Ganztags-Konvertierung, Content-Hash-No-Ops, Auto-Sync-Kandidaten (Sichtbarkeit, Titel-Suffix, Composite-Links über zwei Konten), Tombstone-Deletes, invalid_grant→needs_reauth
