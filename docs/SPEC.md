...
`holiday_show_school`, `holiday_public_color`, `holiday_school_color`, `holiday_last_sync`, `holiday_last_sync_language`, `holiday_language_retry_after` (all admin-only).
