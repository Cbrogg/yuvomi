...
`holiday_show_school`, `holiday_public_color`, `holiday_school_color`, `holiday_last_sync`, `holiday_last_sync_language`, `holiday_retry_after`, `holiday_retry_scope` (all admin-only).
