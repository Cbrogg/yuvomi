...
> `2.20.0` (exact version), `2.20` (latest patch of that minor), plus a moving `main`
> tag for the current development state. To pin production to a known-good release,
> set `image: ghcr.io/ulsklyc/yuvomi:2.20.0` in your compose file and bump it
...
```
yuvomi  | [Yuvomi] Server running on port 3000 | Version 2.20.0
